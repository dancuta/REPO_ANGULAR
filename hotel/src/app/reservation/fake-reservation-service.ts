...
export class FakeReservationService {
  ...
  initWithFakeReservations() {
    ...
    this.reservations.push( { id: ++this.lastId, checkInDate: new Date('2024-07-02'), checkOutDate: new Date('2024-07-06'), guestName: "Jane Doe", roomNumber: 102 } ) ;
    this.reservations.push( { id: ++this.lastId, checkInDate: new Date('2024-07-03'), checkOutDate: new Date('2024-07-07'), guestName: "Joana Doe", roomNumber: 103 } ) ;
